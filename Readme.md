...
* Студент: [Катя Пшеничникова](https://up.htmlacademy.ru/htmlcss/36/user/1869161).
* Наставник: `Роман Марченко` Ссылка на профиль: (https://htmlacademy.ru/profile/id505487).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1869161-sedona-36) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
